...
//	public static final String CREATE_TABLE_ALTER22 = "ALTER TABLE CHECKOUT ADD FOREIGN KEY (user_id) REFERENCES USERS(user_id) ";
//	public static final String CREATE_TABLE_ALTER23 = "ALTER TABLE CHECKOUT ADD FOREIGN KEY (book_id) REFERENCES BOOK(barcode) ";
//	
//	public static final String CREATE_TABLE_ALTER32 = "ALTER TABLE FINE ADD FOREIGN KEY (user_id) REFERENCES USERS(user_id) ";
//	public static final String CREATE_TABLE_ALTER33 = "ALTER TABLE FINE ADD FOREIGN KEY (book_id) REFERENCES BOOK(barcode) ";
//	
//	public static final String CREATE_TABLE_ALTER52 = "ALTER TABLE WAITINGLIST ADD FOREIGN KEY (user_id) REFERENCES USERS(user_id) ";
//	public static final String CREATE_TABLE_ALTER53 = "ALTER TABLE WAITINGLIST ADD FOREIGN KEY (book_id) REFERENCES BOOK(barcode) ";
//								
